...
import { getBlacklist, addToBlacklist, removeFromBlacklist } from "@/lib/api-functions"
...
export default function BlacklistPage() {
  ...
  async function loadBlacklist() {
    ...
    try {
      ...
      console.error("[v0] Error loading blacklist:", error)
    } finally {
      setLoading(false)
    }
  }
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-6 py-12 max-w-7xl">
        <h1 className="text-4xl font-bold mb-8">Черный список доменов</h1>
